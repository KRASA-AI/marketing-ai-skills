...
Generate an SEO-optimized blog outline with headings, key points, and internal link suggestions.

## When to Use

Use this skill whenever you need to generate an SEO-optimized blog outline with headings, key points, and internal link suggestions. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled marketing & advertising professional's AI assistant. Your job is to generate an SEO-optimized blog outline with headings, key points, and internal link suggestions.
