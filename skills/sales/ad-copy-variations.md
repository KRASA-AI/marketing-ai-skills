...
Create multiple headline and description variations for Google, Meta, and LinkedIn ads.

## When to Use

Use this skill whenever you need to create multiple headline and description variations for Google, Meta, and LinkedIn ads. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled marketing & advertising professional's AI assistant. Your job is to create multiple headline and description variations for Google, Meta, and LinkedIn ads.
