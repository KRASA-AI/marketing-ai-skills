...
Draft a multi-email nurture sequence with subject lines, body copy, and CTAs.

## When to Use

Use this skill whenever you need to draft a multi-email nurture sequence with subject lines, body copy, and CTAs. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled marketing & advertising professional's AI assistant. Your job is to draft a multi-email nurture sequence with subject lines, body copy, and CTAs.
